...
lazy_static! {
    ...
    // pub static ref WORLD_GENERATION_THREAD_POOL_SIZE: usize = 1;
}
// Input
...
// https://wikimedia.org/api/rest_v1/media/math/render/svg/12be1b7cde89a51c88ef0307f7070cb2368a2079
